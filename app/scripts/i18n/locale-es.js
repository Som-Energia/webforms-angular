    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('es', {
                ...
                DADES_PUNT_SUBMINISTRAMENT: 'Punto de suministro',
                ...
                CURRENT_RATE: 'Selecciona la tarifa ACTUAL de tu contracto',
                ...
                HELP_POPOVER_CUPS: 'Lo encontrareis en vuestra factura actual. Es un código del estilo ES0031406155637019SB0F.',
                HELP_POPOVER_CUPS_ALTA: 'Es un código que se indica en la factura, del estilo ES0031406155637019SB0F.<br/>Si no lo tienes, sigue <a target="_blank" href="{{url}}">este enlace</a>',
                ...
                NO_IS_HOUSING: 'No has especificado si la dirección corresponde a una vivienda',
