    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('es', {
                ...
                MODIFY_POTTAR_INTRO: '<p>El cambio de potencia y/o tarifa lo valida, aplica y cobra (a través de nuestra factura) la <a target="_blank" href={{url}}>distribuidora de tu zona</a>. El <b>coste regulado</b> es:</p><ul><li>10,94&nbsp;€ (IVA incluido) por solicitud. Es posible cambiar a la vez de tarifa y potencia en una única solicitud.</li><li>En caso de <b>aumentar la potencia</b>, 44,86&nbsp;€ por kW de incremento.</li></ul><p>La distribuidora sólo está obligada a aceptar <b>una sola solicitud de cambio cada 12 meses</b>.</p>',
                HELP_CONTACT_INFO: 'Los datos de contacto las utilizará la <a target="_blank" href="{{url}}">distribuidora de la zona</a> para avisarte en caso de que el técnico encargado necesite acceder al contador.',
                ...
                MODIFY_POTTAR_ONGOING_PROCESS_DETAILS: 'No se pueden comenzar nuevos procesos hasta que no se resuelva el pendiente. Vuelve a intentarlo una vez recibas por correo la resolución del proceso pendiente.',
                MODIFY_POTTAR_NOT_ALLOWED: 'No estás autorizado a hacer esta operación.',
                ...
                MODIFY_POTTAR_UNEXPECTED: 'Se ha producido un error no esperado.',
                MODIFY_POTTAR_UNEXPECTED_DETAILS: 'Pongase en contacto con modifica@somenergia.coop para que os podamos echar una mano. Para identificaros necesitaremos tu NIF y el número del contrato que quereis modificar.',
                API_SERVER_ERROR: 'Error connectando al servidor.',
                API_SERVER_ERROR_DETAILS: 'Su navegador tiene problemas para conectarse a la web de Som Energia. Comprueve que su Comprova que la conexión a internet funcione correctamente. Si no fuera ese el problema, contacte con Som Energia para verificar si se pudo procesar el trámite correctamente.',
                API_SERVER_OFFLINE: 'Nuestros servidores no responden.',
                API_SERVER_OFFLINE_DETAILS: 'Es posible que se estén haciendo tareas de mantenimiento. Vuelva a provar más tarde. Perdone las moléstias.',
                ...
                ENVIAR: 'Enviar',
                ENVIANT: 'Enviando',
                REVIEW_DATA_AND_CONFIRM: 'Revise los datos. Para confirmarlos, pulse el boton del final.',
