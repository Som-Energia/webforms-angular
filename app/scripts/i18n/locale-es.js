    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('es', {
                ...
                API_SERVER_ERROR_DETAILS: 'Su navegador tiene problemas para conectarse a la web de Som Energia. Compruebe que la conexión a internet funcione correctamente. Si no fuera ese el problema, contacte con Som Energia para verificar si se pudo procesar el trámite correctamente.',
                API_SERVER_OFFLINE: 'Nuestros servidores no responden.',
                API_SERVER_OFFLINE_DETAILS: 'Es posible que se estén haciendo tareas de mantenimiento. Vuelva a probar más tarde. Perdone las molestias.',
