    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('es', {
                ...
                MODIFY_POTTAR_UNEXPECTED_DETAILS: 'Póngase en contacto con modifica@somenergia.coop para que os podamos echar una mano. Para identificaros necesitaremos tu NIF y el número del contrato que quereis modificar.',
                API_SERVER_ERROR: 'Error connectando al servidor.',
                API_SERVER_ERROR_DETAILS: 'Su navegador tiene problemas para conectarse a la web de Som Energia. Comprueve que la conexión a internet funcione correctamente. Si no fuera ese el problema, contacte con Som Energia para verificar si se pudo procesar el trámite correctamente.',
                ...
                ENVIAR: 'Enviar',
                ENVIANT: 'Enviando',
                REVIEW_DATA_AND_CONFIRM: 'Revise los datos. Para confirmarlos, pulse el botón del final.',
