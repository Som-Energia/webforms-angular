    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('gl', {
                ...
                INVALID_SUPPLY_POINT_ATTACHMENT: 'El arxivo adjunto supera el límite de 10Mbytes',
                NO_MONOPHASE_CHOICE: 'No has especificado si la instalación es de tipo monofásica o trifásica',
                NO_FARE_CHOSEN: 'No has especificado la tarifa',
                NO_POWER_CHOSEN: 'No has especificado la poténcia',
                NO_POWER_CHOSEN_P2: 'No has especificado la poténcia para el periodo P2',
                NO_POWER_CHOSEN_P3: 'No has especificado la poténcia para el periodo P3',
                INVALID_POWER_20: 'La poténcia para tarifas 2.0 tiene que ser inferior a 10kW',
                INVALID_POWER_21: 'La poténcia para tarifas 2.1 tendría que estar entre 10kW y 15kW',
                INVALID_POWER_30: 'Al menos un periodo tiene que tener una poténcia superior o igual a 15kW',
                NO_HOURLY_DISCRIMINATION_CHOSEN: 'No has especificado si quieres discriminación horaria',
                OWNER_CHANGED_NOT_CHOSEN: 'Hay que indicar si se mantiene el actual titular del contrato',
                UNACCEPTED_GENERAL_CONDITIONS: 'Hay que aceptar las condiciones generales del contrato',
                INVALID_PAYER_IBAN: 'No has especificado correctament el <b>IBAN</b> de la cuenta donde domiciliar',
                ...
                NO_PROXY_NAME: 'No has especificado el nombre del representante',
                NO_PROXY_NIF: 'No has especificado el NIF del representante',
                ...
                NEWMEMBER_OK_REDIRECT_URL: 'https://www.somenergia.coop/gl/pago-realizado/',
                NEWMEMBER_KO_REDIRECT_URL: 'https://www.somenergia.coop/gl/pago-cancelado/',
            })
        ;
    });
