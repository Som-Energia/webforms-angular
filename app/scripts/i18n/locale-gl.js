    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('gl', {
                ...
                CURRENT_RATE: 'Selecciona a tarifa ACTUAL do teu contrato',
                ...
                HELP_POPOVER_CUPS: 'Encontrarédelo na vosa factura actual. É un código do estilo ES0031406155637019SB0F.',
                HELP_POPOVER_CUPS_ALTA: 'É un código que se indica na factura, do estilo ES0031406155637019SB0F.<br/>Se non o tes, segue <a target="_blank" href="{{url}}">este enlace</a>',
                ...
                NO_SUPPLY_POINT_ADDRESS_NUMBER: 'Non especificaches o <b>número</b> no enderezo do punto de subministración',
                ...
                NIF_CCVV: '<p>Lamentabelmente, a lei catalá de cooperativas (Lei 12/2015, de 9 de xullo) non permite ás comunidades veciñais seren socias dunha cooperativa. Por isto, a comunidade non pode asociarse a Som Energia.</p><p>Daquela, para poder contratar a luz da comunidade será preciso facelo utilizando o convite dunha persoa socia, sexa membro da comunidade ou administradora de fincas.</p>',
