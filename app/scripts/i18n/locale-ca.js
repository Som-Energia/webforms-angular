    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('ca', {
                ...
                NO_CANVI_DE_TITULAR: 'Si.<br/>El titular no es canvia',
                ...
                HELPER_ADJUNTAR_BUTLLETI: 'Depenent de la teva situació la distribuidora pot requerir diferents documents com ara el butlletí, el llibre de familia o el certificat de venereas. <a target="_blank" href="{{url}}">Més informació.</a>',
                HELPER_ADJUNTAR_BUTLLETI_URL: 'TODO',
