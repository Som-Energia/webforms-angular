    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('ca', {
                ...
                HELP_TARIFA_CANVI_COMERCIALITZADORA: 'Per evitar problemes de tramitació, poseu <b>la mateixa tarifa i potència que surt a la factura actual</b>. Si voleu fer canvis de tarifa o potència, cal que us espereu a tenir el contracte amb Som Energia per sol·licitar-nos-els.',
                DADES_TITULAR_NOU_CONTRACTE_HELPER: 'Poseu les dades de qui serà titular del nou contracte amb Som Energia. Pot ser el mateix que apareix en el vostre contracte anterior o podeu aprofitar per canviar-ho.',
                DADES_TITULAR_NOU_CONTRACTE_HELPER: 'La persona titular és qui signa el contracte amb Som Energia.',
                VOLS_FER_CANVI_TITULAR: 'Vols fer un canvi de titular?',
                SI_CANVI_DE_TITULAR: 'Aprofitem el pas a SomEnergia per canviar també el titular',
                NO_CANVI_DE_TITULAR: 'Mantenim el titular de l\'anterior contracte amb l\'altra comercialitzadora',
            })
        ;
    });
