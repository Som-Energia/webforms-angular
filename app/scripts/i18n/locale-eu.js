    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('eu', {
                ...
                CURRENT_RATE: 'Hautatu zure kontratuaren ORAINGO tarifa',
                ...
                HELP_POPOVER_CUPS: 'Oraingo fakturan aurkituko duzue. ES0031406155637019SB0F gisako kodea da.',
                HELP_POPOVER_CUPS_ALTA: 'Fakturan agertzen den kodea da, ES0031406155637019SB0F gisakoa.<br/>Ez badaukazu, erabili <a target="_blank" href="{{url}}">hurrengo esteka</a>',
                ...
                NO_SUPPLY_POINT_ADDRESS_NUMBER: 'Ez duzu <b>zenbakia</b> zehaztu hornidura-puntuaren helbidean',
