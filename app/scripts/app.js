    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('es', {
                ...
                PROVINCIA: 'Provincia',
                POBLACIO: 'Población',
                ACCEPTO_POLITICA_PRIVACITAT: 'Acepto la <strong><a target="_blank" href="http://www.somenergia.coop/politica-de-privacitat">política de privacidad</a></strong> de Som Energia',
