    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('es', {
                ...
                FORMULARI_CONTRACTACIO: '',
                NUMERO_SOCI: '',
                HELP_POPOVER: '',
                CARREGAR_DADES_SOCI_VINCULAT: '',
                SOCI_VINCULAT: '',
                NO_TROBEM_CAP_SOCI_VINCULAT: '',
                NO_ETS_SOCI_FES_TE_AQUI: '',
                INICIAR_CONTRACTACIO: '',
                DADES_PUNT_SUBMINISTRAMENT: '',
                DADES_PUNT_SUBMINISTRAMENT_HELPER: '',
                NUMERO_DE_CUPS: '',
                HELP_POPOVER_CUPS: '',
                HELP_POPOVER_CNAE: '',
                QUINA_POTENCIA_TENS_CONTRACTADA: '',
                HELP_POPOVER_POWER: '',
                QUINA_TARIFA_TENS_CONTRACTADA: '',
                SELECCIONAR: '',
                HELP_POPOVER_RATE: '',
                INFORMACIO_OPCIONAL: '',
                HELP_POPOVER_OPTIONAL_INFO: '',
                CONSUM_ANUAL_ESTIMAT: '',
                REFERENCIA_CATASTRAL: '',
                ADJUNTAR_ULTIMA_FACTURA: '',
                SEGUENT_PAS: '',
                DADES_TITULAR_NOU_CONTRACTE: '',
                DADES_TITULAR_NOU_CONTRACTE_HELPER: '',
                VOLS_FER_CANVI_TITULAR: '',
                SI: 'Si',
                NO: 'No',
                HELP_POPOVER_OWNER: '',
                EL_TITULAR_ES: '',
