    ...
    .config(function($translateProvider) {
        $translateProvider
           ...
           .translations('gl', {
                ...
                PROVINCIA: 'Provincia',
                POBLACIO: 'Poboación',
                ACCEPTO_POLITICA_PRIVACITAT: 'Acepto a <strong><a target="_blank" href="http://www.somenergia.coop/es/politica-de-privacidad">política de privacidade</a></strong> de Som Energia',
                ACCEPTO_CONDICIONS_I_POLITICA_PRIVACITAT: 'Acepto as <strong><a target="_blank" href="#">condicións xerais do contrato</a></strong> e a <strong><a target="_blank" href="#">política de privacidade</a></strong>',
           ...
           .translations('eu', {
                ...
                POBLACIO: 'Herria',
                ACCEPTO_POLITICA_PRIVACITAT: 'Som Energiaren <strong><a target="_blank" href="http://www.somenergia.coop/es/politica-de-privacidad">pribatutasun-politika</a></strong>onartzen dut',
                ACCEPTO_CONDICIONS_I_POLITICA_PRIVACITAT: 'Kontratuaren baldintza orokorrak <strong><a target="_blank" href="#">onartzen ditut</a></strong> i la <strong><a target="_blank" href="#">pribatutasun-politika</a></strong>',
