...
//        $locationProvider.html5Mode(true);
    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('es', {
                ...
                AVIS_CANVI_TITULAR: 'Atención: En ciertos casos, la distribuidora puede solicitar la renovación del Boletín de la Instalación, si este está caducado (20 años). Más información <a target="_blank" href="http://es.support.somenergia.coop/article/505-que-es-el-boletin-electrico">aquí</a>',
                SI: 'Si',
                NO: 'No',
            ...
            .translations('ca', {
                ...
                AVIS_CANVI_TITULAR: 'Atenció: En alguns casos, la distribuïdora pot demanar la renovació del Butlletí de la Instal·lació, si aquest està caducat (20 anys). Més informació <a target="_blank" href="http://ca.support.somenergia.coop/article/500-que-es-el-butlleti-electric">aquí</a>',
                SI: 'Sí',
                NO: 'No',
           ...
           .translations('gl', {
                ...
                AVIS_CANVI_TITULAR: 'Atención: En certos casos a distribuidora pode solicitar a renovación do Boletín de Instalación se este está caducado (20 anos). Máis información <a target="_blank" href="http://gl.support.somenergia.coop/article/556-boletin-electrico">aquí</a>',
                SI: 'Si',
                NO: 'Non',
           ...
           .translations('eu', {
                ...
                AVIS_CANVI_TITULAR: 'Adi: Hainbat kasutan, instalazio-buletina iraungita badago (20 urte), enpresa banatzaileak berritzea eskatuko du. Informazio gehiago <a target="_blank" href="http://eu.support.somenergia.coop/article/555-boletin-electrico">hemen</a>',
                SI: 'Bai',
                NO: 'Ez',
    ...
    .constant('cfg', {
        ...
        //API_BASE_URL: 'https://api.somenergia.coop/',     // TODO production environment
