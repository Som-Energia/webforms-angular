    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('es', {
                ...
                DADES_TITULAR_NOU_CONTRACTE_HELPER: 'Poner los datos de quien va a ser el flamante titular del nuevo contrato con Som Energia. Puede ser el mismo que aparece en vuestro contrato anterior o podéis aprovechar ahora para cambiarlo.',
            ...
            .translations('ca', {
                ...
                DADES_TITULAR_NOU_CONTRACTE_HELPER: 'Poseu les dades de qui serà el flamant titular del nou contracte amb Som Energia. Pot ser el mateix que apareix en el vostre contracte anterior o podeu aprofitar per canviar-ho.',
